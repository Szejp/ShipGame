...
namespace Enviroment
{
    ...
    {
        [SerializeField] private List<Clusterable> obstacles;
        [SerializeField] private Vector3 volumeVector = Vector3.one;
        [SerializeField] private float checkboxVolume = 2;
        [SerializeField] private float interval = 1;
        [SerializeField] private int maxNest = 3;
        [SerializeField] private CollectorCollider collectorCollider;
        
        private ISpawner spawner;
        private int joinNestingFactor = 0;

        [SerializeField] private Vector2[] sideObstaclePositions;
