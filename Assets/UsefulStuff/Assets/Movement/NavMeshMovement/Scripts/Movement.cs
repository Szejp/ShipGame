...
namespace UsefulStuff.Assets.Movement.NavMeshMovement.Scripts {
	...
	public class Movement : MonoBehaviour {
		...
		protected bool GroundCheck() {
			return UnityEngine.Physics.CheckCapsule(_collider.bounds.center, new Vector3(_collider.bounds.center.x, _collider.bounds.min.y + 0.1f, _collider.bounds.center.z), 0.16f, 1 << LayerMask.NameToLayer("Ground"));
		}
	}
}
